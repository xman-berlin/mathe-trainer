        ...
        provideRouter([]),
        {
          ...
          useValue: {
            generateProblem: jasmine.createSpy('generateProblem').and.returnValue({
              ...
              correctAnswer: 10,
              unit: 'euro',
              sampleRechnung: '1 + 2 = 10',
              sampleAntwort: 'Die Familie bezahlt 10€.',
              answerKeywords: ['familie'],
              numberRange: 'bis100',
            }),
            getWorksheetExamples: jasmine.createSpy('getWorksheetExamples').and.returnValue([]),
