# Two-step Sachaufgaben (Rechnung + Antwortsatz)

Worksheet-style two-step German word problems in Mathe / Sachaufgaben.
The child enters both a calculation (Rechnung) and a German answer sentence (Antwort).
...
- [x] Write e2e tests (navigation + both fields)
