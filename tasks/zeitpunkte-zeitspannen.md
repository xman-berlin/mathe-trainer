...
Train duration (Zeitspannen) and delayed departure (Verspätung) like a German Grundschule worksheet.

## Checklist

- [x] Duration/delay service with German time + duration formatting and parsing
- [x] Exercise component with Zeitspannen and Verspätung subtypes
